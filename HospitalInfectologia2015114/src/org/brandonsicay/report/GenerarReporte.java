...
package org.brandonsicay.report;

import net.sf.jasperreports.engine.util.JRLoader; // tipo de archivo para levantarlo
import net.sf.jasperreports.engine.JasperReport;
import net.sf.jasperreports.engine.JasperPrint;
import net.sf.jasperreports.engine.JasperFillManager;
import net.sf.jasperreports.engine.JasperPrintManager;
import net.sf.jasperreports.view.JasperViewer; // poder visualizar el reporte
import java.util.Map;
import java.io.InputStream; //levantar el archivo
